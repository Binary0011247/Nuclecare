...
def update_baseline():
    ...
    cur.execute("""
        ...
        """,(user_id, baseline_python.get('avg_systolic'), baseline_python.get('stddev_systolic'), baseline_python.get('avg_diastolic'), baseline_python.get('stddev_diastolic'), baseline_python.get('avg_heart_rate'), baseline_python.get('stddev_heart_rate'),baseline_python.get('avg_blood_glucose'), baseline_python.get('stddev_blood_glucose')))
